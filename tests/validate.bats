...
@test "valid decomposer.json file" {
...
@test "valid decomposer.json file with development-only indicator" {
...
@test "decomposer.json doesn't contain JSON content" {
...
@test "decomposer.json doesn't contain JSON object" {
...
@test "library version not a string" {
...
@test "library revision not a string" {
...
@test "library target-dir not a string" {
...
@test "library missing psr0 or psr4" {
...
@test "library conflicting psr0 and psr4" {
...
@test "library dev not a boolean" {
